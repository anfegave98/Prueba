...
<html lang="en">
    <head>
        <title>BI-Stock | Administradores</title>
                      ...
                      <li class="nav-item dropdown ml-4">
                        ...
                        <li class="nav-item dropdown d-none d-xl-inline-block">
                            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                                <span class="profile-text">Hello, <span id="display_name" >Admin</span> !</span>
                    ...
                    <ul class="nav">
                        <li class="nav-item nav-profile">
                            <div class="nav-link">
                                ...
                                <button class="btn btn-success btn-block">Nuevo préstamo
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table id="admin_table" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Nombres</th>
