...
<html lang="en">
    ...
    <body>
                            ...
                            <div class="col-md-6 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form id="clientAdd" class="forms-sample">
                                            <div class="form-group col-12">
                                                <label for="clientName">Nombres</label>
                                                <input type="text" class="form-control" id="clientName" placeholder="Ingrese sus nombres">
                                            </div>
                                            <div class="form-group col-12">
                                            ...
                                            <div class="form-group col-12">
                                                ...
                                                <input  type="email" class="form-control" id="clientEmail" placeholder="Ingrese su correo principal">
                                            </div>
                                            <div class="form-group col-12">
        ...
        <script src="assets/js/clientesAdd.js"></script>
